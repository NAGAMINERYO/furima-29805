...
ActiveRecord::Schema.define(version: 2020_10_22_074619) do
  ...
  create_table "purchasers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
